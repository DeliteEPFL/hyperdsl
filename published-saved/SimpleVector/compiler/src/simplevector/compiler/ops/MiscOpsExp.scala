...
trait MiscOpsExp extends MiscOps with BaseFatExp with EffectExp {
  ...
  case class Misc_Exit(__arg0: Rep[Int])(implicit val __pos: SourceContext) extends Def[Nothing] {
  }
  ...
  def misc___whiledo(__arg0:  => Rep[Boolean],__arg1:  => Rep[Unit])(implicit __pos: SourceContext) = {
    ...
    reflectEffect[Unit](Misc___whileDo(b___arg0,b___arg1)(__pos), sb___arg0 andThen ((sb___arg1 andThen sb___arg0).star))
  }
  def misc___ifthenelse[T:Manifest](__arg0:  => Rep[Boolean],__arg1:  => Rep[T],__arg2:  => Rep[T])(implicit __pos: SourceContext) = {
    ...
    reflectEffect[T](Misc___ifThenElse[T](b___arg0,b___arg1,b___arg2)(implicitly[Manifest[T]],__pos), sb___arg0 andThen ((sb___arg1 andThen ((sb___arg2 andThen sb___arg1).star) andThen sb___arg0).star))
  }
  ...
  def misc_unsafemutable[T:Manifest](__arg0: Rep[T])(implicit __pos: SourceContext) = {
    reflectMutable[T](Misc_UnsafeMutable[T](__arg0)(implicitly[Manifest[T]],__pos))
  }
  def misc_getmaxheapsize()(implicit __pos: SourceContext) = {
    reflectPure(Misc_GetMaxHeapSize()(__pos))
  }
  ...
  override def aliasSyms(e: Any): List[Sym[Any]] = e match {
    ...
    case Misc_UnsafeMutable(__arg0) => Nil
  ...
  override def copySyms(e: Any): List[Sym[Any]] = e match {
    ...
    case Misc_UnsafeMutable(__arg0) => syms(__arg0)
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit pos: SourceContext): Exp[A] = (e match {
    ...
    case mn@Misc_GetMaxHeapSize() => misc_getmaxheapsize()(mn.__pos)
    case Reflect(mn@Misc_GetMaxHeapSize(), u, es) => reflectMirrored(Reflect(Misc_GetMaxHeapSize()(mn.__pos), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
