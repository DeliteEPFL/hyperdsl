...
trait SHashMapOpsExp extends SHashMapCompilerOps with BaseFatExp with EffectExp {
  ...
  case class SHashMap2_Apply[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K])(implicit val __pos: SourceContext) extends Def[V] {
    val _mK = implicitly[Manifest[K]]
    val _mV = implicitly[Manifest[V]]
  }

  case class SHashMap2_Update[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K],__arg2: Rep[V])(implicit val __pos: SourceContext) extends Def[Unit] {
    val _mK = implicitly[Manifest[K]]
    val _mV = implicitly[Manifest[V]]
  }

  case class SHashMap2_Contains[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K])(implicit val __pos: SourceContext) extends Def[Boolean] {
    val _mK = implicitly[Manifest[K]]
    val _mV = implicitly[Manifest[V]]
  }
  ...
  def shashmap_shashmap[K:Manifest,V:Manifest]()(implicit __pos: SourceContext) = {
    reflectMutable[scala.collection.mutable.HashMap[K,V]](SHashMap_SHashMap[K,V]()(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos))
  }
  def shashmap_from_arrays[K:Manifest,V:Manifest](__arg0: Rep[ForgeArray[K]],__arg1: Rep[ForgeArray[V]])(implicit __pos: SourceContext) = {
    reflectMutable[scala.collection.mutable.HashMap[K,V]](Shashmap_from_arrays[K,V](__arg0,__arg1)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos))
  }
  ...
  def shashmap_apply[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K])(implicit __pos: SourceContext) = {
    reflectPure(SHashMap2_Apply[K,V](__arg0,__arg1)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos))
  }
  def shashmap_update[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K],__arg2: Rep[V])(implicit __pos: SourceContext) = {
    reflectWrite[Unit](__arg0)(SHashMap2_Update[K,V](__arg0,__arg1,__arg2)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos))
  }
  def shashmap_contains[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K])(implicit __pos: SourceContext) = {
    reflectPure(SHashMap2_Contains[K,V](__arg0,__arg1)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos))
  }
  def shashmap_keys[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]])(implicit __pos: SourceContext) = {
    shashmap_keys_impl[K,V](__arg0)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
  }
  def shashmap_values[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]])(implicit __pos: SourceContext) = {
    shashmap_values_impl[K,V](__arg0)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
  }
  ...
  override def mirror[A:Manifest](e: Def[A], f: Transformer)(implicit pos: SourceContext): Exp[A] = (e match {
    ...
    case mn@SHashMap2_Apply(__arg0,__arg1) => shashmap_apply(f(__arg0),f(__arg1))(mtype(mn._mK),mtype(mn._mV),mn.__pos)
    case Reflect(mn@SHashMap2_Apply(__arg0,__arg1), u, es) => reflectMirrored(Reflect(SHashMap2_Apply(f(__arg0),f(__arg1))(mtype(mn._mK),mtype(mn._mV),mn.__pos), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case mn@SHashMap2_Update(__arg0,__arg1,__arg2) => shashmap_update(f(__arg0),f(__arg1),f(__arg2))(mtype(mn._mK),mtype(mn._mV),mn.__pos)
    case Reflect(mn@SHashMap2_Update(__arg0,__arg1,__arg2), u, es) => reflectMirrored(Reflect(SHashMap2_Update(f(__arg0),f(__arg1),f(__arg2))(mtype(mn._mK),mtype(mn._mV),mn.__pos), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
    case mn@SHashMap2_Contains(__arg0,__arg1) => shashmap_contains(f(__arg0),f(__arg1))(mtype(mn._mK),mtype(mn._mV),mn.__pos)
    case Reflect(mn@SHashMap2_Contains(__arg0,__arg1), u, es) => reflectMirrored(Reflect(SHashMap2_Contains(f(__arg0),f(__arg1))(mtype(mn._mK),mtype(mn._mV),mn.__pos), mapOver(f,u), f(es)))(mtype(manifest[A]), pos)
...
trait ScalaGenSHashMapOps extends ScalaGenFat {
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    ...
    case mn@SHashMap2_Apply(__arg0,__arg1) => 
      stream.println("val "+quote(sym)+" = {")
      stream.print(""+quote(__arg0)+"("+quote(__arg1)+")")
      stream.println("}")

    case mn@SHashMap2_Update(__arg0,__arg1,__arg2) => 
      stream.println("val "+quote(sym)+" = {")
      stream.print(""+quote(__arg0)+".put("+quote(__arg1)+","+quote(__arg2)+"); ()")
      stream.println("}")

    case mn@SHashMap2_Contains(__arg0,__arg1) => 
      stream.println("val "+quote(sym)+" = {")
...
trait CGenSHashMapOps extends CGenFat {
  val IR: SHashMapOpsExp
  import IR._
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    case mn@SHashMap_SHashMap() => 
      ...
      stream.print("new std::map<"+remap(mn._mK)+","+remap(mn._mV)+">()")
      stream.println(";")

    case mn@Shashmap_keys_array(__arg0) => 
      stream.print(remapWithRef(sym.tp) + " " + quote(sym) + " = ")
      stream.print("new "+remap(sym.tp)+"("+quote(__arg0)+"->size()); int keys_idx_"+quote(__arg0)+" = 0; for(std::map<"+remap(mn._mK)+","+remap(mn._mV)+">::iterator it = "+quote(__arg0)+"->begin(); it != "+quote(__arg0)+"->end(); ++it)"+quote(sym)+"->update(keys_idx_"+quote(__arg0)+"++, it->first);")
      stream.println(";")

    case mn@Shashmap_values_array(__arg0) => 
      stream.print(remapWithRef(sym.tp) + " " + quote(sym) + " = ")
      stream.print("new "+remap(sym.tp)+"("+quote(__arg0)+"->size()); int values_idx_"+quote(__arg0)+" = 0; for(std::map<"+remap(mn._mK)+","+remap(mn._mV)+">::iterator it = "+quote(__arg0)+"->begin(); it != "+quote(__arg0)+"->end(); ++it)"+quote(sym)+"->update(values_idx_"+quote(__arg0)+"++, it->second);")
      stream.println(";")

    case mn@SHashMap2_Apply(__arg0,__arg1) => 
      stream.print(remapWithRef(sym.tp) + " " + quote(sym) + " = ")
      stream.print(""+quote(__arg0)+"->find("+quote(__arg1)+")->second")
      stream.println(";")

    case mn@SHashMap2_Update(__arg0,__arg1,__arg2) => 
      stream.print(""+quote(__arg0)+"->insert(std::pair<"+remap(mn._mK)+","+remap(mn._mV)+">("+quote(__arg1)+","+quote(__arg2)+"))")
      stream.println(";")

    case mn@SHashMap2_Contains(__arg0,__arg1) => 
      stream.print(remapWithRef(sym.tp) + " " + quote(sym) + " = ")
      stream.print(""+quote(__arg0)+"->find("+quote(__arg1)+") != "+quote(__arg0)+"->end()")
      stream.println(";")
