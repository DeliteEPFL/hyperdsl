...
trait Tup2OpsExp extends Tup2CompilerOps with BaseFatExp with DeliteStructsExp {
  ...
  def tup2_unpack[A:Manifest,B:Manifest](t: Rep[Tup2[A,B]])(implicit __pos: SourceContext) = {
    tup2_unpack_impl8[A,B](t)(implicitly[Manifest[A]],implicitly[Manifest[B]],__pos)
  }
  def tup2_pack[A:Manifest,B:Manifest](t: Tuple2[Rep[A],Rep[B]])(implicit __pos: SourceContext,__imp1: Overload8) = {
    tup2_pack_impl8[A,B](t)(implicitly[Manifest[A]],implicitly[Manifest[B]],__pos)
  }
  ...
  def tup2_tostring[A:Manifest,B:Manifest](t: Rep[Tup2[A,B]]) = {
    tup2_tostring_impl8[A,B](t)(implicitly[Manifest[A]],implicitly[Manifest[B]])
  }
