...
case class Tup4[A:Manifest,B:Manifest,C:Manifest,D:Manifest](___1: A, ___2: B, ___3: C, ___4: D) {
  ...
  override def toString() = {
    val t = this
    tup4_tostring_impl2[A,B,C,D](t)(implicitly[Manifest[A]],implicitly[Manifest[B]],implicitly[Manifest[C]],implicitly[Manifest[D]])
  }
}
  ...
  def tup4_unpack[A:Manifest,B:Manifest,C:Manifest,D:Manifest](t: Rep[Tup4[A,B,C,D]])(implicit __pos: SourceContext) = {
    tup4_unpack_impl2[A,B,C,D](t)(implicitly[Manifest[A]],implicitly[Manifest[B]],implicitly[Manifest[C]],implicitly[Manifest[D]],__pos)
  }
  def tup4_pack[A:Manifest,B:Manifest,C:Manifest,D:Manifest](t: Tuple4[Rep[A],Rep[B],Rep[C],Rep[D]])(implicit __pos: SourceContext) = {
    tup4_pack_impl2[A,B,C,D](t)(implicitly[Manifest[A]],implicitly[Manifest[B]],implicitly[Manifest[C]],implicitly[Manifest[D]],__pos)
  }
