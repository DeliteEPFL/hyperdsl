...
trait SHashMapOps extends Base {
  ...
  class SHashMapscalacollectionmutableHashMapOpsCls[K:Manifest,V:Manifest](val self: Rep[scala.collection.mutable.HashMap[K,V]])(implicit __pos: SourceContext) {
    def apply(__arg1: Rep[K])(implicit __pos: SourceContext,__imp1: Overload2) = shashmap_apply[K,V](self,__arg1)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
    def update(__arg1: Rep[K],__arg2: Rep[V])(implicit __pos: SourceContext,__imp1: Overload2) = shashmap_update[K,V](self,__arg1,__arg2)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
  }


  def infix_contains[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]],__arg1: Rep[K])(implicit __pos: SourceContext,__imp1: Overload2) = shashmap_contains[K,V](__arg0,__arg1)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
  def infix_keys[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]])(implicit __pos: SourceContext) = shashmap_keys[K,V](__arg0)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
  def infix_values[K:Manifest,V:Manifest](__arg0: Rep[scala.collection.mutable.HashMap[K,V]])(implicit __pos: SourceContext) = shashmap_values[K,V](__arg0)(implicitly[Manifest[K]],implicitly[Manifest[V]],__pos)
